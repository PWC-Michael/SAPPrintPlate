              ...
              <b-col cols="12" sm="3" md="3" >
                <b-card :no-body="true" footer-class="px-3 py-2">
                  <b-card-body class="p-3 clearfix">                      
                    ...
                    <div class="h5 text-warning mb-0">{{regReport.postcode}}</div>
                  </b-card-body>
                </b-card>
              </b-col>
              <b-col cols="12" sm="3" md="3" >
                <b-card :no-body="true" footer-class="px-3 py-2">
                  <b-card-body class="p-3 clearfix">                      
                    ...
                    <div class="h5 text-warning mb-0">{{regReport.postcode_position}}</div>
                  </b-card-body>
                </b-card>
              </b-col>
              <b-col cols="12" sm="3" md="3" >
                <b-card :no-body="true" footer-class="px-3 py-2">
                  <b-card-body class="p-3 clearfix">                      
                    ...
                    <div class="h5 text-warning mb-0">{{regReport.slogan}}</div>
                  </b-card-body>
                </b-card>
              </b-col>
            </b-row>
...
export default {
  ...
  created() {
    this.$data.regParam = this.$route.params.reg;
    this.getRegReport();
  },
  methods: {
    getRegReport() {
      ...
      getRegReport(this.$http, this.$data.regParam)
        .then((data) => {
          this.$data.regReport = data.plates[0];
          this.$data.plateLoaded = true;
          console.log(this.$data.regReport);
          return getArea(this.$http, this.$data.regReport.group_id)
        })
        .then((areas) => {
